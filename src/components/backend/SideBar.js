    ...
    render(){
        return (
            <aside className="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <img src="/admin/img/AdminLTELogo.png" alt="AdminLTE Logo" className="brand-image img-circle elevation-3" styleName="opacity: .8" />
                ...
                <div className="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div className="image">
                    <img src="/admin/img/user2-160x160.jpg" className="img-circle elevation-2" alt="UserImage" />
                    </div>
                    <div className="info">
